...
class IMDBDataset(object):
    ...
    def _read_vocab(self):
        import codecs
        with codecs.open(self.vocab_path, 'r','utf-8') as f:
    ...
    def read_text(self, path):
        ...
        import codecs
        pos_list = [codecs.open(x, 'r','utf-8').read().lower() for x in pos_files]
        neg_list = [codecs.open(x, 'r','utf-8').read().lower() for x in neg_files]
